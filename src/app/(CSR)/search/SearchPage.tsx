  ...
  return (
    <div>
      <Alert>
        ...
        This route handler then fetches the data from Unsplash API and returns it to the client.
      </Alert>
      ...
      <div className='d-flex flex-column aligh-items-center'>
        {searchResultsLoading && <Spinner animation='border' className="d-block m-auto text-primary"/>}
